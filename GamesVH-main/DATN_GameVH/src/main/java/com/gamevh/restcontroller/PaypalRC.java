...
public class PaypalRC {
    ...
    public String generateAccessToken() {
        String auth = this.getAuth(
                "AcaTYl3bLV1GeujO_XGfc3P3KGUeGUj_EMo8cLcqIl5esaS0GNpVrIX7o5P-mFXFJG86aM1McdZx0YSP",
                "EE_vf-AKL1o_keZLmgTdybMaiPEzcgmOM3ANm-mZHAMGDSoXTBZ45WnIywmAYNHe_Kg5zfqdBy63aFsH"
        );
